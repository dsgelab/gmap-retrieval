...
def find_zoom_level(latitudes, ideal_side_length, pixels_per_side):
    """
    Given an ideal side length of satellite images, find the best matching zoom level to feed into Google Maps Static API
    and resulting side lengths of satellite images given the best matching zoom levels
